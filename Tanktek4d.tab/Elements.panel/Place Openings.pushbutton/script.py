...
#Custom Imports
from GUI.ElementSelector import CableTraySelectionFilter, Selector, FamilySymbolName
...
wall_cs.Origin = loc_curve.GetEndPoint(0)
...
fs = FamilySymbolName.get_family_symbol(doc, family_name, family_symbol_name)
