...
doc = __revit__.ActiveDocument.Document #active document in Revit (revit model open)
uidoc = __revit__.ActiveDocument #UI document, necessary to get elements, create selections, change views, making zoom in elements, etc
